...
class m170801_061245_create_menu extends Migration
{
    ...
    public function safeUp()
    {
        ...
        // 写入后台管理下的导航栏目
        $this->batchInsert($this->table, $insertKey, [
            [$intParentId, '角色管理', 'menu-icon fa fa-graduation-cap', $prefix . 'role/index', 1, $time, 1, $time, 1],
            [$intParentId, '角色分配', 'menu-icon fa fa-paper-plane', $prefix . 'auth-assignment/index', 2, $time, 1, $time, 1],
            [$intParentId, '权限管理', 'menu-icon fa fa-fire', $prefix . 'authority/index', 3, $time, 1, $time, 1],
            [$intParentId, '规则管理', 'menu-icon fa fa-shield', $prefix . 'auth-rule/index', 4, $time, 1, $time, 1],
        ]);
