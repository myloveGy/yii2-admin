                    ...
                    <div id="edit-basic" class="tab-pane in active">
                        ...
                        <form class="form-horizontal" name="user" id="sUserForm">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label no-padding-right"
                                               for="form-field-username">账号名</label>
                                        <div class="col-sm-8">
                                            <input class="col-xs-12 col-sm-10" type="text" id="form-field-username"
                                                   name="username" required="true" rangelength="[2, 20]"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="input-small" type="text" name="firstName"
                                                   id="form-field-first" placeholder="性" rangelength="[1, 2]" value=""/>
                                            <input class="input-small" type="text" name="lastName" id="form-field-last"
                                                   placeholder="名" rangelength="[1, 2]" value=""/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="input-medium">
                                        <div class="input-group">
                                            <input class="input-medium" id="form-field-date" type="text" value=""
                                                   name="birthday" placeholder="2016-06-01"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <label class="inline">
                                        <input type="radio" name="sex" value="1" checked="true" required="true"
                                               number="true" class="ace"/>
                                        <span class="lbl middle"> 男 </span>
                                    </label>

                                    &nbsp; &nbsp; &nbsp;
                                    <label class="inline">
                                        <input type="radio" name="sex" value="0" required="true" number="true"
                                               class="ace"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"
                                       for="form-field-comment">座右铭</label>
                                <div class="col-sm-9">
                                    <textarea id="form-field-comment" name="maxim" rows="3" cols="50"
                                              rangelength="[2, 255]"></textarea>
                                </div>
                            </div>
                            <div class="space"></div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right"
                                       for="form-field-email">电子邮件</label>
                                <div class="col-sm-9">
                                <span class="input-icon input-icon-right">
                                    <input type="email" name="email" required="true" email="true" rangelength="[2, 40]"
                                           id="form-field-email" value="<?= $admin->email ?>"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                <span class="input-icon input-icon-right">
                                    <input type="url" id="form-field-website" name="home_url" rangelength="[2, 50]"
                                           url="true" value=""/>
                            ...
                            <div class="form-group">
                                ...
                                <span class="input-icon">
                                    <input type="text" value="" name="facebook" rangelength="[2, 50]"
                    ...
                    <div id="edit-password" class="tab-pane">
                        ...
                        <form class="form-horizontal" name="userPassword" id="sUserPass">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="password" required="true" rangelength="[6, 20]"
                                           id="form-field-pass1"/>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="repassword" required="true" equalTo="#form-field-pass1"
                                           rangelength="[6, 20]" id="form-field-pass2"/>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            <div class="clearfix form-actions">
